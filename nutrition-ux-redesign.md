...
O documento principal esta em [docs/nutrition-ux-redesign.md](./docs/nutrition-ux-redesign.md).

Se voce abriu este arquivo esperando a proposta completa, use o caminho abaixo:

- [docs/nutrition-ux-redesign.md](./docs/nutrition-ux-redesign.md)
