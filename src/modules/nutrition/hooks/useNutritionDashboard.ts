...
import type { DailySummary, DiaryHistoryEntry, DiaryItemSnapshot, MealPlan, NutritionGoal, NutritionObjective } from "@/modules/nutrition/domain/types";
...
export function useNutritionDashboard(activeUser: any, today: string, canUseBrowserPersistence: boolean) {
