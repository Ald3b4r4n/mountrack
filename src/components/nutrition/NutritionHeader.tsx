...
function MobileSummaryStrip({
  ...
  return (
    <div className="grid min-w-0 gap-2.5">
      ...
      <div className="glass-panel static-panel min-w-0 overflow-hidden rounded-[1rem] border-[#38bdf8]/14 bg-[linear-gradient(145deg,rgba(6,22,45,0.9),rgba(5,20,38,0.7))] p-3.5">
        <div className="mb-3 flex items-start justify-between gap-3">
          <div className="min-w-0">
            ...
            <span className="mt-1.5 inline-flex max-w-full items-center overflow-hidden rounded-full border border-[#38bdf8]/18 bg-[#38bdf8]/10 px-2.5 py-1 text-[0.72rem] text-sky-200">
              <span className="truncate">
                {Math.round(waterRatio)}% da meta
              </span>
            </span>
          </div>
          <div className="flex shrink-0 flex-col items-end gap-1.5">
            <span className="text-right text-[0.78rem] text-[var(--text-secondary)]">
              {formatMilliliters(summary.waterIntakeMl)}
              <br />
              <span className="text-[0.72rem]">
                de {formatMilliliters(summary.targetWaterMl)}
              </span>
            </span>
          </div>
        </div>
        <div className="progress-track mb-3 h-[0.5rem]">
          <div
