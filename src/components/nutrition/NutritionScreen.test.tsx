...
describe("NutritionScreen", () => {
  ...
  it("opens with the time-based meal in focus and navigates to search when add button clicked", async () => {
    ...
    // Button should remain visible even in search area for easy access to add more items
    expect(
