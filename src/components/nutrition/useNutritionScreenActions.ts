...
interface NutritionScreenActionsDeps {
  ...
  focusTodayDashboard: (options?: { openMealsSummary?: boolean; openDiaryPanel?: boolean }) => void;
  announceDiarySuccess: (foodLabel: string, mealDefinition: MealDefinition) => void;
