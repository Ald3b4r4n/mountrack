...
export default function LogDose() {
  ...
  const handleSave = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Se não for apenas nota, salva o peso se foi preenchido
      if (logType !== "note" && weight) {
      ...
      >
        ...
        >
          ...
          <p className="page-subtitle" style={{ marginBottom: "1.5rem" }}>
            Escolha o que deseja registrar hoje.
          </p>
          ...
          >
            ...
            {logType === "dose" && (
              ...
              >
                <label htmlFor="dose" className="label">
                  Dose aplicada (mg)
                </label>
                <select
                  id="dose"
            ...
            {/* Peso — não aparece se for só nota */}
            {logType !== "note" && (
              <div
                className="anim-enter"
                style={{
            ...
            >
              ...
              <textarea
                ...
                placeholder="Como foi o dia, sintomas, alimentação, treino ou algo importante para lembrar."
                className="input-field"
                style={{ resize: "none" }}
              />
            </div>
