...
export default function Journal() {
  ...
  return (
    <ProtectedRoute>
      <main
        className="container"
        style={{ maxWidth: "700px", paddingTop: "3rem", paddingBottom: "4rem" }}
      >
        <div
          style={{
            display: "flex",
        ...
        >
          <div>
            <h1
              className="glow-text anim-enter"
              style={{ fontSize: "2rem", marginBottom: "0.25rem" }}
            >
              Diário
            </h1>
            <p className="page-subtitle anim-enter anim-delay-1">
              Relatos e observações da jornada.
            </p>
          </div>
        ...
        {loading ? (
          ...
          >
            ...
            >
              Use o campo de observações ao registrar uma dose, pesagem ou nota
              livre para acompanhar a jornada.
            </p>
            <Link
              href="/log"
                ...
                >
                  <div>
                    ...
                    >
                      ...
                      {!log.dose &&
                      (log.type === "weight" || log.type === undefined) ? (
