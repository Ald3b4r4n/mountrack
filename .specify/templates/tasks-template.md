...
**Tests**: Tests are mandatory for behavior changes. Test tasks MUST be written
before implementation tasks and MUST be verified red before production code is
changed.
...
- [ ] T004 [P] Confirm test command and red-state workflow for this feature
...
- [ ] T013 [P] [US1] Unit test for [business rule] in tests/unit/test_[name].py
...
- [ ] T022 [P] [US2] Unit test for [business rule] in tests/unit/test_[name].py
...
- [ ] T029 [P] [US3] Unit test for [business rule] in tests/unit/test_[name].py
...
- [ ] TXXX [P] Update README.md or record why no README change is needed
- [ ] TXXX Code cleanup and refactoring
- [ ] TXXX Performance optimization across all stories
- [ ] TXXX [P] Additional regression tests in tests/unit/ or relevant test path
- [ ] TXXX Security hardening
- [ ] TXXX Run quickstart.md validation
- [ ] TXXX Run `npm test`
- [ ] TXXX Run `npm run lint`
- [ ] TXXX Run `npm run build` when routes, config, dependencies, auth, billing, or integrations changed
- [ ] TXXX Run `npm audit --audit-level=high` when dependencies changed
...
- Update docs/ and README.md impact before closing the feature
